...
WebUI.setText(findTestObject('Checkout/txt_firstName'), '')

WebUI.setText(findTestObject('Checkout/txt_lastName'), '')

WebUI.setText(findTestObject('Checkout/txt_zipcode'), '12920')

WebUI.click(findTestObject('Checkout/btn_continue'))

WebUI.verifyElementText(findTestObject('Global Object/txt_messageError'), 'Error: First Name is required')
...
WebUI.verifyElementText(findTestObject('Global Object/txt_messageError'), 'Error: Last Name is required')
...
WebUI.verifyElementText(findTestObject('Global Object/txt_messageError'), 'Error: Postal Code is required')
